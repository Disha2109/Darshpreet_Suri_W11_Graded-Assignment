...
data = pd.read_csv('/home/vboxuser/flask_proj/Microservices/data/breast_cancer.csv')
...
# Export model
joblib.dump(pipe, gzip.open('/home/vboxuser/flask_proj/Microservices/model/model_binary.dat.gz', "wb"))
